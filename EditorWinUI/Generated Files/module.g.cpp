...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"EditorWinUI.MainPage"))
    {
        return winrt_make_EditorWinUI_MainPage();
    }

    if (requal(name, L"EditorWinUI.SceneViewport"))
    {
        return winrt_make_EditorWinUI_SceneViewport();
    }

    if (requal(name, L"EditorWinUI.XamlMetaDataProvider"))
    {
        return winrt_make_EditorWinUI_XamlMetaDataProvider();
    }

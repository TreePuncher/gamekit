...
namespace VK_internal
{
	...
	struct vkDirectContext : public IDirectContext
	{
		...
		void SetGraphicsDescriptorSet(size_t idx, const struct DescriptorSet& DH) final;
		...
		void SetComputeDescriptorSet(size_t idx, const struct DescriptorSet& DH) final;
